...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = Conv1D(96, 128, 3, 2)
        self.conv4 = Conv1D(128, 256, 3, 2)
        self.pool2 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv5 = Conv1D(384, 512, 3, 2)
        self.conv6 = Conv1D(512, 1024, 3, 2)
        self.pool3 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv7 = Conv1D(1536, 1536, 3, 2)
        self.conv8 = Conv1D(1536, 1536, 3, 2)
