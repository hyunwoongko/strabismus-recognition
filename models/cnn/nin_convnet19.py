...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = MlpConv1D(96, 128, kernel_size=3)
        self.conv4 = MlpConv1D(128, 256, kernel_size=3)
        self.pool2 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv5 = MlpConv1D(384, 512, kernel_size=3)
        self.conv6 = MlpConv1D(512, 1024, kernel_size=3)
