...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = Conv1D(4, 64, kernel_size=5)
        self.conv2 = Conv1D(64, 64, kernel_size=3)
        self.pool1 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv3 = Conv1D(64, 256, kernel_size=3)
        self.conv4 = Conv1D(256, 256, kernel_size=3)
        self.pool2 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv5 = Conv1D(256, 1024, kernel_size=3)
        self.conv6 = Conv1D(1024, 1024, kernel_size=3)
