...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = Conv1D(4, 32, 3, 4)
        self.conv2 = Conv1D(32, 64, 3, 4)
        ...
        self.conv5 = Conv1D(384, 512, 3, 4)
        self.conv6 = Conv1D(512, 1024, 3, 4)
        self.pool3 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.conv7 = Conv1D(1536, 1536, 3, 4)
        self.conv8 = Conv1D(1536, 1536, 3, 4)
